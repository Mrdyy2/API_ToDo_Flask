...
function CreateToDoItems() {
    if (todoValue.value === "" && todoTitle.value === "") {
      todoAlert.innerText = "Please enter your todo text!";
      todoValue.focus();
    } else {
      let IsPresent = false;
      todo.forEach((element) => {
        if (element.item == todoTitle.value) {
          IsPresent = true;
        }
      });
      ...
      const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoTitle.value}<br>${todoValue.value}</div><div>
